...
function get_CURl($url) {
  $curl = curl_init();
  curl_setopt($curl, CURLOPT_URL, $url); // BENAR: tanpa tanda kutip
...
$result = get_CURl('https://www.googleapis.com/youtube/v3/channels?part=snippet,statistics&id=UCOVcfJG5DMoaDKTicCsL4kQ&key=AIzaSyBuUYcok-UvmfQj-T06zeSdtRzkQu1ZQmI');
...
$urlLatestVideo = 'https://www.googleapis.com/youtube/v3/search?key=AIzaSyBuUYcok-UvmfQj-T06zeSdtRzkQu1ZQmI&channelId=UCOVcfJG5DMoaDKTicCsL4kQ&maxResults=1&order=date&part=snippet';
$result = get_CURL($urlLatestVideo);
$LatestVideoId = $result['items'][0]['id']['videoId'];

//Instagram API
$clientId = '17841406538197368';
$accessToken = 'IGAAJjErMeMUFBZAE1zaHV4WHVjdXpxRnA2cXBnbkRtNDVNM2VwYlJ6RU1PbXF6Y2p1SzJfUHV3Q3VlbFl4NkZAkWUpmRC10a3V4b2F6V0xoVFkxaE9CNVFjWnVKUVJ5SlRwSUVvRXlDczA2TmlvQUZAmTXdQbGZAzaXQ3YTZAkeUk4VQZDZD';
...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#home">Tari Dwi Syafitri Hartono</a>
    ...
    <div class="jumbotron" id="home">
      <div class="container">
        <div class="text-center">
          ...
          <h1 class="display-4">Tari Dwi Syafitri Hartono </h1>
    ...
    <section class="about" id="about">
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-md-5">
            <p>Saya Tari Dwi Syafitri Hartono, seorang mahasiswa dengan passion di bidang pemrograman dan konten digital. Dari coding hingga membuat video, saya senang berbagi ilmu dan inspirasi kepada orang lain.</p>
          </div>
          <div class="col-md-5">
            <p>Lewat perjalanan ini, saya ingin membuktikan bahwa usia muda bukan penghalang untuk berkarya dan memberi dampak.</p>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="col-md-5">
            <div class="row">
              ...
              <div class="col-md-8">
                ...
                <div class="g-ytsubscribe" data-channelid="UCOVcfJG5DMoaDKTicCsL4kQ" data-layout="default" data-count="default">
    ...
    <section class="portfolio" id="portfolio">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md mb-4">
            <div class="card">
              <img class="card-img-top" src="img/thumbs/12.png" alt="Card image cap">
              <div class="card-body">
                <p class="card-text">Membuat Project REST-API.</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md mb-4">
            <div class="card">
              <img class="card-img-top" src="img/thumbs/13.png" alt="Card image cap">
              <div class="card-body">
                <p class="card-text">Membuat Website Inventory untuk tugas kerja praktek.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-4">
            ...
            <ul class="list-group mb-4">
              ...
              <li class="list-group-item">Jl. Sungai Bangek No. 14</li>
    ...
    <footer class="bg-dark text-white mt-5">
      <div class="container">
        <div class="row">
          <div class="col text-center">
            <p>Integrasi Aplikasi Perusahaan &copy; 2025.</p>
          </div>
        </div>
      </div>
    </footer>
